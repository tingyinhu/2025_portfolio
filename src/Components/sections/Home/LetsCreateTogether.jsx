      ...
      <div className="container flex flex-col md:flex-row items-start justify-between gap-10 md:gap-30">
        ...
        <div className="md:w-1/2 w-full space-y-6">
          ...
          <p className="font-description font-light text-black s text-sm-p md:text-md-p lg:text-lg-p">
            I’m always looking to collaborate on meaningful and creative endeavors. 
            Let’s team up and make something amazing happen!
          </p>
          <Lottie animationData={LetsCreateTogetherAnimation} className="mx-auto w-100 py-10" />
        </div>

        {/* Form */}
        <form action="https://getform.io/f/aejrrqeb" method="POST" className="md:w-1/2 w-full space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            
            {/* Name Field */}
            <div>
              <label htmlFor="name" className="block font-description font-light text-sm-p md:text-md-p mb-2">Name</label>
              <input 
                type="text" 
                name="name" 
                id="name" 
            ...
            {/* Email Field */}
            <div>
              <label htmlFor="email" className="block font-description font-light text-sm-p md:text-md-p mb-2">Email</label>
              <input 
                type="email" 
                name="email" 
                id="email" 
            ...
            <div className="col-span-1 md:col-span-2">
              <label htmlFor="message" className="block font-description font-light text-sm-p md:text-md-p mb-2">Message</label>
              <textarea 
                name="message" 
                id="message" 
